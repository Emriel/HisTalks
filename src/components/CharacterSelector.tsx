    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8 mt-6">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto">
          Select a historical figure to begin an immersive conversation. 
          Experience their unique perspectives, knowledge, and personality as if they were present today.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-8">
        <div className="relative flex-grow">
          ...
          <input
            ...
            placeholder="Search historical figures by name or era..."
            value={searchTerm}
            onChange={(e) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {currentCharacters.map((character) => (
          ...
          >
            ...
            <div className="p-4">
              <h3 className="text-xl font-serif font-bold text-blue-900">{character.name}</h3>
              <p className="text-sm text-slate-500 mb-2">{character.era}</p>
              <p className="text-sm text-slate-700">{character.shortBio}</p>
            </div>
